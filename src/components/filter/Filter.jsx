        ...
        >
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <button
              ...
              className="px-4 py-2 bg-pink-400 text-gray-950 text-sm font-medium rounded-md transition duration-300 ease-in-out transform hover:bg-pink-600 hover:scale-105"
